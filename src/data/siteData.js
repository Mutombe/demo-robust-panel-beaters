...
const siteData = {
  business: {
    name: "Robust Panel Beaters",
    legalName: "Robust Panel Beaters",
    tagline: "Robust Results for Every Repair",
    description: "Robust Panel Beaters on Seke Road delivers strong, reliable auto body repairs. From minor dents to major collision damage, our team restores your vehicle with precision and care.",
    phone: "+263 77 361 4556",
    phoneRaw: "+263773614556",
    whatsappNumber: "263773614556",
    email: "info@robustpanelbeaters.co.zw",
    address: "667 Seke Rd, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "robust-panel-beaters-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  hero: {
    badge: "Seke Road's Premier Panel Beating Workshop",
    titleParts: [
      { text: "BUILT TO" },
      { text: "RESTORE", highlight: true },
      { text: "BUILT TO LAST." },
    ],
    subtitle: "Robust Panel Beaters on Seke Road delivers strong, reliable auto body repairs. From minor dents to major collision damage, our team restores your vehicle with precision and care.",
    ctaPrimary: "Book Assessment",
    ctaSecondary: "Our Services",
    trustBadge: "3500+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "3500+", label: "Vehicles Repaired" },
  ...
  homeTestimonials: [
    { text: "Robust Panel Beaters repaired my car after a serious collision and you honestly cannot tell it was ever in an accident. The paint match is perfect and the finish is flawless.", name: "Tendai Maposa", role: "Insurance Claim Client", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We send all our fleet vehicles to Robust Panel Beaters for body repairs. Their turnaround time is the best in Harare and the quality is consistently excellent.", name: "Grace Nhamo", role: "Fleet Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "Had my classic car restored by Robust Panel Beaters and the attention to detail was extraordinary. They treated it like their own and the result is show-quality.", name: "Robert Chimedza", role: "Classic Car Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "After the hailstorm, Robust Panel Beaters removed every dent from my car without repainting. Saved me a fortune and the car looks brand new again.", name: "Farai Mutizwa", role: "Hail Damage Client", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    story: [
      "Since 2015, Robust Panel Beaters has been the workshop Harare trusts for quality collision repair. Our Seke Road location makes us accessible to drivers from across the city and surrounding areas.",
      "Over 3,500 vehicles restored and a team that takes pride in every repair. Our name says it all -- robust results that stand the test of time.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Robust Panel Beaters with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Robust Panel Beaters repaired my car after a serious collision and you honestly cannot tell it was ever in an accident. The paint match is perfect and the finish is flawless.", name: "Tendai Maposa", role: "Insurance Claim Client", rating: 5 },
      { text: "We send all our fleet vehicles to Robust Panel Beaters for body repairs. Their turnaround time is the best in Harare and the quality is consistently excellent.", name: "Grace Nhamo", role: "Fleet Manager", rating: 5 },
      { text: "Had my classic car restored by Robust Panel Beaters and the attention to detail was extraordinary. They treated it like their own and the result is show-quality.", name: "Robert Chimedza", role: "Classic Car Owner", rating: 5 },
      { text: "After the hailstorm, Robust Panel Beaters removed every dent from my car without repainting. Saved me a fortune and the car looks brand new again.", name: "Farai Mutizwa", role: "Hail Damage Client", rating: 5 },
      { text: "Turnaround time was incredible. Robust Panel Beaters had my car back in 4 days looking better than before the accident.", name: "Simba Karonga", role: "Quick Turnaround Client", rating: 5 },
      { text: "Insurance claim was handled entirely by Robust Panel Beaters. I did not have to make a single phone call to the insurer.", name: "Douglas Mhizha", role: "Insurance Client", rating: 5 },
      { text: "The custom bodywork Robust Panel Beaters did on my project car is magazine-worthy. True artisans.", name: "Linda Masuku", role: "Custom Car Client", rating: 5 },
      { text: "Fair pricing and no hidden charges. Robust Panel Beaters quoted accurately and the final bill matched exactly.", name: "Patrick Makoni", role: "Budget-Conscious Client", rating: 5 },
      ...
      { text: "The spray booth at Robust Panel Beaters produces finishes that are genuinely indistinguishable from factory paint.", name: "Brian Mutema", role: "Full Respray Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "667 Seke Rd, Harare, Zimbabwe", phone: "+263 77 361 4556", email: "info@robustpanelbeaters.co.zw" },
    ],
  },

  homeCta: {
    title: "DAMAGED?, WE FIX IT",
    subtitle: "Robust Panel Beaters on Seke Road delivers strong, reliable auto body repairs. From minor dents to major collision damage, our team restores your vehicle with precision and care.",
    ctaPrimary: "Book Assessment",
    ctaSecondary: "Chat on WhatsApp",
    whatsappText: "Hello Robust! I need a panel beating quote.",
    backgroundImage: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=1920&q=85",
  },

  footer: {
    description: "Robust Panel Beaters on Seke Road delivers strong, reliable auto body repairs. From minor dents to major collision damag...",
    copyright: "Robust Panel Beaters",
  },
};
